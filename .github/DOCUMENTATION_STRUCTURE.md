...
| AI 全局治理 | `AI_INITIALIZATION.md` | AI 开发规则、流程约束、协作口径 |
| AI 工作流编排 | `.github/AGENTS.md`、`.github/WORKFLOW_CHECKLIST.md` | 代理职责、执行清单 |
| 库级技术文档 | `docs/*.md` | 架构、流程、协议 |
...
3. 工作流或提示词变化：同次迭代更新 `.github` 文档与 `AI_INITIALIZATION.md`。
