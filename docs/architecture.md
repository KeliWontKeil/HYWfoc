...
| `L3` 应用算法层 | `foc_control_c11_entry.c`、`foc_control_c12_init.c`、`foc_control_c21_outer_loop.c`、`foc_control_c22_current_loop.c`、`foc_control_c23_motor_param_learn.c`、`foc_control_c24_compensation.c`、`foc_control_c25_cfg_state.c`、`foc_control_c31_actuation.c`、`sensor.c`、`svpwm.c`、`protocol_core.c` | 控制算法、初始化标定、采样处理、协议纯处理内核 |
...
4. 配置与补偿：`C25`（运行态配置）、`C24`（齿槽补偿，可裁剪）。
