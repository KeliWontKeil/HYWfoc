...
#define FOC_MOTOR_INIT_DIRECTION_DEFAULT -1
...
#define COMMAND_MANAGER_DEFAULT_ANGLE_SPEED_RAD_S 0.1f
...
#define FOC_SENSOR_KALMAN_ANGLE_EST_ERR 0.01f
#define FOC_SENSOR_KALMAN_ANGLE_PROC_NOISE 0.01f
...
#define COMMAND_MANAGER_DEFAULT_PID_SPEED_KP 2.5f
