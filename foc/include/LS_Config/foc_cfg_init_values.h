...
#define FOC_MOTOR_INIT_SET_VOLTAGE_DEFAULT 10.8f
...
#define DEBUG_STREAM_OSC_DEFAULT_SHOW_VBUS_VOLTAGE FOC_CFG_ENABLE
...
#define COMMAND_MANAGER_DEFAULT_PID_CURRENT_KP 1.5f
...
#define COMMAND_MANAGER_DEFAULT_CURRENT_SOFT_SWITCH_AUTO_OPEN_IQ_A 0.45f
#define COMMAND_MANAGER_DEFAULT_CURRENT_SOFT_SWITCH_AUTO_CLOSED_IQ_A 0.80f
