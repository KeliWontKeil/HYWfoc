...
/* Drift tracking defaults (abc-frame DC tracking during rotation). */
#define FOC_SENSOR_DRIFT_TRACK_MIN_SAMPLES 50U
#define FOC_SENSOR_DRIFT_TRACK_EMA_ALPHA 0.02f
#define FOC_SENSOR_DRIFT_TRACK_MIN_SPREAD_A 0.3f
...
#define FOC_DEFAULT_SPEED_ANGLE_TRANSITION_START_RAD 1.0f
#define FOC_DEFAULT_SPEED_ANGLE_TRANSITION_END_RAD 2.0f

#define FOC_SVPWM_PRE_LPF_ALPHA 0.20f
#define FOC_ZERO_VECTOR_CLAMP_VOLTAGE_THRESHOLD_V 0.1f

/* PID default gains. */
#define COMMAND_MANAGER_DEFAULT_PID_ANGLE_KP 1.6f
...
#define COMMAND_MANAGER_DEFAULT_PID_CURRENT_KP 15.0f
#define COMMAND_MANAGER_DEFAULT_PID_CURRENT_KI 100.0f
...
#define COMMAND_MANAGER_DEFAULT_CURRENT_SOFT_SWITCH_AUTO_CLOSED_IQ_A 0.60f
...
#define FOC_COGGING_CALIB_SPEED_RAD_S 0.6f
