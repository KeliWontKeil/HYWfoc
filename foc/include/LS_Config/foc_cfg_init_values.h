...
#define DEBUG_STREAM_OSC_DEFAULT_SHOW_EXEC_TIME_US FOC_CFG_ENABLE
...
#define FOC_SENSOR_SAMPLE_OFFSET_PERCENT_DEFAULT 50.0f
...
#define COMMAND_MANAGER_DEFAULT_PID_CURRENT_KP 5.0f
#define COMMAND_MANAGER_DEFAULT_PID_CURRENT_KI 30.0f
#define COMMAND_MANAGER_DEFAULT_PID_CURRENT_KD 0.001f

#define FOC_CURRENT_LOOP_ERROR_DEADBAND_A 0.05f
#define FOC_CURRENT_LOOP_INTEGRAL_SUPPRESS_LEAK 0.98f
#define FOC_CURRENT_LOOP_KI_LOW_CURRENT_START_A 0.00f
#define FOC_CURRENT_LOOP_KI_LOW_CURRENT_END_A 1.60f
#define FOC_CURRENT_LOOP_KI_LOW_CURRENT_SCALE 0.10f
...
#define COMMAND_MANAGER_DEFAULT_CURRENT_SOFT_SWITCH_AUTO_CLOSED_IQ_A 0.40f
#define COMMAND_MANAGER_DEFAULT_CURRENT_SOFT_SWITCH_ENABLE FOC_CFG_DISABLE

#define FOC_CURRENT_SOFT_SWITCH_BLEND_TAU_DEFAULT_SEC 0.60f

/* Cogging compensation defaults (optional feature). */
#define FOC_COGGING_LUT_POINT_COUNT 64U
#define FOC_COGGING_LUT_IQ_LSB_A 0.01f
#define FOC_COGGING_COMP_SPEED_GATE_RAD_S 8.0f
#define FOC_COGGING_COMP_IQ_LIMIT_A 0.35f
...
#define FOC_COGGING_LEARN_STEP_SETTLE_MS 6U
#define FOC_COGGING_LEARN_SAMPLE_COUNT 8U
#define FOC_COGGING_LEARN_MIN_VALID_PERCENT 70U
#define FOC_COGGING_LEARN_ERR_TO_IQ_GAIN_A_PER_RAD 0.35f
