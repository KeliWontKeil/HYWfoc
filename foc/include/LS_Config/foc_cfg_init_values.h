...
#define FOC_MOTOR_INIT_SET_VOLTAGE_DEFAULT 9.4f//1.6f
...
#define COMMAND_MANAGER_DEFAULT_PID_SPEED_KI 0.0f
#define COMMAND_MANAGER_DEFAULT_PID_SPEED_KD 0.0f

#define COMMAND_MANAGER_DEFAULT_PID_CURRENT_KP 16.0f
#define COMMAND_MANAGER_DEFAULT_PID_CURRENT_KI 40.0f
