...
#define FOC_SENSOR_ANGLE_LPF_ENABLE FOC_CFG_DISABLE

/* Modulation and control feature switches. */
#define FOC_CURRENT_LOOP_PID_ENABLE FOC_CFG_DISABLE
#define FOC_CURRENT_SOFT_SWITCH_ENABLE FOC_CFG_DISABLE
...
#define FOC_COGGING_INIT_LEARN_ENABLE FOC_CFG_DISABLE
#define FOC_COGGING_DEBUG_DUMP_ENABLE FOC_CFG_DISABLE
 ...
 */
#define FOC_PROTOCOL_ENABLE_SENSOR_SAMPLE_OFFSET FOC_CFG_DISABLE
#define FOC_PROTOCOL_ENABLE_TELEMETRY_REPORT FOC_CFG_DISABLE
#define FOC_PROTOCOL_ENABLE_CURRENT_PID_TUNING FOC_CFG_DISABLE
