...
/*
 * =====================================================================
 *  Calibration API 鈥?always declared (stubs when CALIB disabled)
 * =====================================================================
 */
...
void FOC_CoggingCalibRequestStart(foc_motor_t *motor);
...
void FOC_CoggingCalibRequestDump(foc_motor_t *motor);
void FOC_CoggingCalibRequestExport(foc_motor_t *motor);
