...
/* ── SMO默认参数 ── */
/* ── SMO 角度估计方法 ── */
#define FOC_ESTIM_SMO_ANGLE_METHOD             FOC_ESTIM_SMO_ANGLE_METHOD_LPF_ATAN2
...
#define FOC_ESTIM_SMO_BEMF_LPF_FC            20000.0f
#define FOC_ESTIM_SMO_SPEED_LPF_FC           5.0f

#define FOC_ESTIM_SMO_K_SLIDE_DEFAULT        0.8f
