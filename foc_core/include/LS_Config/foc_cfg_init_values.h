...
#define COMMAND_MANAGER_DEFAULT_PID_SPEED_KP 0.05f
#define COMMAND_MANAGER_DEFAULT_PID_SPEED_KI 0.60f
...
#define FOC_SMO_ACCEL_PRECONV_SPEED_THRESHOLD_RAD_S  4.0f /* 预收敛速度门限 */
