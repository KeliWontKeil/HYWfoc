...
/* Scheduler rates. */
#define FOC_SCHEDULER_TICK_HZ 3000U
#define FOC_SCHEDULER_CONTROL_HZ 1500U
...
#define FOC_MOTOR_INIT_MECH_ZERO_DEFAULT_RAD 2.6016//FOC_MECH_ANGLE_AT_ELEC_ZERO_UNDEFINED
