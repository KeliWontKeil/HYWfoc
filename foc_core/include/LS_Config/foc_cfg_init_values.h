...
#define FOC_MOTOR_INIT_POLE_PAIRS_DEFAULT 11U//FOC_POLE_PAIRS_UNDEFINED//11U
...
#define COMMAND_MANAGER_DEFAULT_PID_SPEED_KI 0.7f
#define COMMAND_MANAGER_DEFAULT_PID_SPEED_KD 0.0f
#define FOC_SPEED_PID_INTEGRAL_LIMIT_DEFAULT 4.0f

#define COMMAND_MANAGER_DEFAULT_PID_CURRENT_KP 10.0f
...
#define FOC_ESTIM_SMO_SPEED_LPF_FC           100.0f

#define FOC_ESTIM_SMO_K_SLIDE_DEFAULT        0.75f
...
/* ── 全域加速器默认参数 ── */
#define FOC_ACCEL_RAMP_RATE_LOW_RAD_S2       10.0f    /* LOW 区域加速度 */
#define FOC_ACCEL_RAMP_RATE_HIGH_RAD_S2      10.0f   /* HIGH/FULL 区域加速度 */
