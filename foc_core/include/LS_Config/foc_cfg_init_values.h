...
#define COMMAND_MANAGER_DEFAULT_ANGLE_SPEED_RAD_S 15.0f
...
#define COMMAND_MANAGER_DEFAULT_PID_SPEED_KI 0.4f
...
#define FOC_OPENLOOP_RAMP_RATE_RAD_S2            5.0f
#define FOC_OPENLOOP_CURRENT_A                   0.5f
#define FOC_OPENLOOP_TARGET_SPEED_RAD_S          5.0f
#define FOC_OPENLOOP_SWITCH_SPEED_THRESHOLD_RAD_S 5.0f

/* ── Source Manager 低/高速 source 切换默认参数 ── */
#define FOC_SOURCE_SWITCH_SETTLE_CYCLES              50U
#define FOC_SOURCE_SWITCH_SPEED_THRESH_HIGH_DEFAULT  15.0f
#define FOC_SOURCE_SWITCH_SPEED_THRESH_LOW_DEFAULT   12.0f
