...
#define FOC_MOTOR_INIT_STATOR_INDUCTANCE_HENRY   0.002f
...
#define FOC_MOTOR_INIT_MECH_ZERO_DEFAULT_RAD 5.7722f//FOC_MECH_ANGLE_AT_ELEC_ZERO_UNDEFINED//
#define FOC_MOTOR_INIT_DIRECTION_DEFAULT FOC_DIR_NORMAL//FOC_DIR_UNDEFINED
...
#define DEBUG_STREAM_OSC_DEFAULT_SHOW_SPEED_ACTIVE_MECH  FOC_CFG_ENABLE
#define DEBUG_STREAM_OSC_DEFAULT_SHOW_SPEED_STANDBY_MECH FOC_CFG_ENABLE
...
#define FOC_LED_RUN_BLINK_HALF_PERIOD_TICKS 1U
#define FOC_LED_COMM_PULSE_TICKS 10U

/* ── SMO默认参数 ── */
/* ── SMO 角度估计方法 ── */
#define FOC_ESTIM_SMO_ANGLE_METHOD             FOC_ESTIM_SMO_ANGLE_METHOD_PLL

#define FOC_ESTIM_SMO_PLL_KP_DEFAULT         120.0f
#define FOC_ESTIM_SMO_PLL_KI_DEFAULT         400.0f
...
#define FOC_ESTIM_SMO_K_SLIDE_DEFAULT        0.4f
...
#define FOC_SOURCE_SWITCH_SPEED_THRESH_LOW_DEFAULT   (FOC_ACCEL_SPEED_LIMIT_LOW_RAD_S - 0.5f)
#define FOC_SOURCE_SWITCH_SPEED_SCALE 0.6f
