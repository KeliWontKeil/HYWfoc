...
/*FOC_CURRENT_SOFT_SWITCH_MODE_AUTO以抑制低电流采样噪声，非必要不开启，会带来区间抖震 */
#define COMMAND_MANAGER_DEFAULT_CURRENT_SOFT_SWITCH_AUTO_OPEN_IQ_A 0.10f
...
#define FOC_SOURCE_SWITCH_SETTLE_CYCLES              20U
