...
#define FOC_SCHEDULER_MONITOR_HZ 100U
...
#define FOC_MOTOR_INIT_MECH_ZERO_DEFAULT_RAD FOC_MECH_ANGLE_AT_ELEC_ZERO_UNDEFINED//0.0f
...
#define COMMAND_MANAGER_DEFAULT_PID_SPEED_KP 0.7f
#define COMMAND_MANAGER_DEFAULT_PID_SPEED_KI 0.2f
...
#define FOC_ESTIM_SMO_CONVERGE_BEMF_V        0.5f
...
#define FOC_ESTIM_SMO_DQ_TRACKING_THRESHOLD  0.3f

/* ── OpenLoop angle source / low-speed policy defaults ── */
#define FOC_OPENLOOP_CURRENT_A                   0.4f

/* ── 全域加速器默认参数 ── */
#define FOC_ACCEL_RAMP_RATE_LOW_RAD_S2       30.0f    /* LOW 区域加速度 */
#define FOC_ACCEL_RAMP_RATE_HIGH_RAD_S2      50.0f   /* HIGH/FULL 区域加速度 */
#define FOC_ACCEL_SPEED_LIMIT_LOW_RAD_S      2.6f   /* LOW 区域速度上限 */
...
#define FOC_SMO_ACCEL_PRECONV_SPEED_THRESHOLD_RAD_S  1.0f /* 预收敛速度门限 */

#define FOC_SOURCE_SWITCH_SPEED_THRESH_HIGH_DEFAULT  2.2f
#define FOC_SOURCE_SWITCH_SPEED_THRESH_LOW_DEFAULT   1.8f
