...
#define FOC_MOTOR_INIT_MECH_ZERO_DEFAULT_RAD 0.0f
...
/* ── 强拖启动策略默认参数，需要修改宏名 ── */
#define FOC_STARTUP_OPENLOOP_RAMP_RATE_RAD_S2    5.0f
#define FOC_STARTUP_OPENLOOP_CURRENT_A           0.5f
#define FOC_STARTUP_OPENLOOP_TARGET_SPEED_RAD_S  5.0f
#define FOC_STARTUP_OPENLOOP_SPEED_THRESHOLD_RAD_S 5.0f

/* ── 过渡管理默认参数 ── */
#define FOC_TRANSITION_SETTLE_CYCLES             50U
#define FOC_TRANSITION_SPEED_THRESH_HIGH_DEFAULT 15.0f
#define FOC_TRANSITION_SPEED_THRESH_LOW_DEFAULT   12.0f
