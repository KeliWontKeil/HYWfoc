...
#define COMMAND_MANAGER_DEFAULT_PID_SPEED_KP 0.035f
...
#define FOC_ESTIM_SMO_CONVERGE_BEMF_V        0.20f
#define FOC_ESTIM_SMO_LOST_THRESHOLD         50U
#define FOC_ESTIM_SMO_BEMF_SPEED_RATIO       0.001f  /* 反电动势/电角速度宽松下限（Ke 下限，按电机标定，仅抓极端不一致） */
#define FOC_ESTIM_SMO_DQ_TRACKING_THRESHOLD  0.1f
#define FOC_ESTIM_SMO_SAT_CURRENT_A          0.10f
#define FOC_ESTIM_SMO_BEMF_LPF_FC            2000.0f
#define FOC_ESTIM_SMO_SPEED_LPF_FC           2000.0f
...
#define FOC_ACCEL_SPEED_LIMIT_LOW_RAD_S      15.0f   /* LOW 区域速度上限 */
#define FOC_ACCEL_SPEED_LIMIT_HIGH_RAD_S     50.0f   /* HIGH/FULL 区域速度上限 */

#define FOC_SOURCE_SWITCH_SETTLE_CYCLES              200U
#define FOC_SOURCE_SWITCH_DEGRADE_CONFIRM_CYCLES     5U   /* 降域(回LOW)确认拍数，更敏捷；升域用 SETTLE_CYCLES */
#define FOC_SMO_ACCEL_PRECONV_SPEED_THRESHOLD_RAD_S  5.0f /* 预收敛速度门限 */
#define FOC_SOURCE_SWITCH_SPEED_THRESH_HIGH_DEFAULT  (FOC_ACCEL_SPEED_LIMIT_LOW_RAD_S - 1.5f)
#define FOC_SOURCE_SWITCH_SPEED_THRESH_LOW_DEFAULT   (FOC_ACCEL_SPEED_LIMIT_LOW_RAD_S - 3.0f)
