...
#define FOC_MOTOR_INIT_RESISTANCE_OHM 5.5f
...
/* 速度环已改为纯速度反馈（误差单位 rad/s），以下为速度环起始值，需按工况重标定 */
#define COMMAND_MANAGER_DEFAULT_PID_SPEED_KP 0.03f
#define COMMAND_MANAGER_DEFAULT_PID_SPEED_KI 0.40f
